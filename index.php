...
<link rel="stylesheet" type="text/css" href="css\signin.css">
      <form class="form-signin" method="POST" role="form" action="antwoord.php">
			...
			<button class="btn btn-lg btn-primary btn-block" type="submit" name="send" value="verzenden">Verzend met post </button>
      </form>
</div>
...
<link rel="stylesheet" type="text/css" href="css\signin.css">
      <form class="form-signin" method="get" role="form" action="antwoord.php">
			...
			<button class="btn btn-lg btn-primary btn-block" type="submit" name="send" value="verzenden">Verzend met get </button>
      </form>
</div>
